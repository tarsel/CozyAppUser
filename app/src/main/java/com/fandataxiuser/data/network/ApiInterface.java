package com.fandataxiuser.data.network;
...
import com.fandataxiuser.data.network.model.Coupon;
...
import com.fandataxiuser.data.network.model.Rental;
...
public interface ApiInterface {
    ...
    Observable<List<Service>> services(@Query("type")String type);
    ...
    @FormUrlEncoded
    @POST("api/user/send/request")
    Observable<Object> sendRequestOne(@FieldMap HashMap<String, Object> params);
