...
//        if (!TextUtils.isEmpty(SharedHelper.getKey(MvpApplication.getInstance(), "access_token", null)))
    ...
    public void onSuccess(User user) {
        ...
        {
            SharedHelper.putKey(this, "lang", "en");

        }else {

            SharedHelper.putKey(this, "lang", AppConstant.getCurrentLanguage(SplashActivity.this));
        }
            ...
            try {
                for (Service service : services)
                    if (!TextUtils.isEmpty(service.getMarker())) {
                        ...
                        if (b != null)
                            SharedHelper.putKey(this, service.getName() + service.getId(), encodeBase64(b));
                    }
            } catch (Exception e) {
                e.printStackTrace();
            }
