...
import com.fandataxiuser.utils.AppConstant;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_PICK_LOCATION) if (resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                map.put("type", type);
                map.put("address", data.getStringExtra(Constants.RIDE_REQUEST.SRC_ADD));
                map.put("latitude", data.getDoubleExtra(Constants.RIDE_REQUEST.SRC_LAT, 0.0));
                map.put("longitude", data.getDoubleExtra(Constants.RIDE_REQUEST.SRC_LONG, 0.0));
